...
case $ans in 
    d) 
        clear ; echo "Backing up file." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/default.txt $apt_root ; check_apt ;;
    cf)
        clear ; echo "Backing up file." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/cloudflare.txt $apt_root ; check_apt ;;
    abs)
        clear ; echo "Backing Up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/albatross.txt $apt_root ; check_apt ;;
    aua)
        clear ; echo "Backing Up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/astra-isp.txt $apt_root ; check_apt ;;
    bm)
        clear ; echo "Backing Up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/bardia-moshiri $apt_root ; check_apt ;;
    bfsu)
        clear ; echo "Backing Up File " ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/bfsu-cn.txt $apt_root ; check_apt ;;
    g24)
        clear ; echo "Backing Up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/grimler.txt $apt_root ; check_apt ;;
    kct)
        clear ; echo "Backing Up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/kcubeterm.txt $apt_root ; check_apt ;;
    lh)
        clear ; echo "Backing up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/librehat.txt $apt_root ; check_apt ;;
    nju)
        clear ; echo "Backing up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/nju-cn.txt $apt_root ; check_apt ;;
    tu)
        clear ; echo "Backing up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/tsinghua-univ-cn.txt $apt_root ; check_apt ;;
    ustc) 
        clear ; echo "Backing up File." ; root_apt ; rm -rf "$apt_root" ; cp -r assets/repl/Root/ustc-cn.txt $apt_root ; check_apt ;;
    0)
      break ;;
    *)
