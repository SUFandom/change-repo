...
case $ans in 
    d) 
        clear ; echo "Backing up file." ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/default.txt $apt_main ; check_apt ;;
    cf)
        clear ; echo "Backing up file." ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/cloudflare.txt $apt_main ; check_apt ;;
    abs)
        clear ; echo "Backing Up File." ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/albatross.txt $apt_main ; check_apt ;;
    aua)
        clear ; echo "Backing Up File." ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/astra-isp.txt $apt_main ; check_apt ;;
    bm)
        clear ; echo "Backing Up File." ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/bardia-moshiri $apt_main ; check_apt ;;
    bfsu)
        clear ; echo "Backing Up File " ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/bfsu-cn.txt $apt_main ; check_apt ;;
    g24)
        clear ; echo "Backing Up File" ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/grimler.txt $apt_main ; check_apt ;;
    kct)
        clear ; echo "Backing Up File" ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/kcubeterm.txt $apt_main ; check_apt ;;
    lh)
        clear ; echo "Backing up File" ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/librehat.txt $apt_main ; check_apt ;;
    nju)
        clear ; echo "Backing up File" ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/nju-cn.txt $apt_main ; check_apt ;;
    tu)
        clear ; echo "Backing up File" ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/tsinghua-univ-cn.txt $apt_main ; check_apt ;;
    ustc) 
        clear ; echo "Backing up File" ; main_apt ; rm -rf "$apt_main" ; cp -r assets/repl/Main/ustc-cn.txt $apt_main ; check_apt ;;
    0)
      break ;;
    *)
